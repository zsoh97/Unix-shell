...
public class ErrorConstants {
    ...
    // `cp` related
    public static final String ERR_MISSING_SRC_OR_DEST= "Missing source or/and destination file operand";
    public static final String ERR_SAME_SOURCE_AND_DEST = "Source and destination cannot be the same";
    public static final String ERR_NO_RECURSIVE = "-r not specified; omitting directory";
    public static final String ERR_MULTIPLE_TIMES = "Source file or directory specified more than once";
